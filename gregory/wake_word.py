...
class WakeWordDetector:
    def __init__(self):
        ...
        # The ALSA default device must be configured via ~/.asoundrc to route
        # capture through the plug plugin (plughw:0,0) rather than dsnoop —
        # dsnoop corrupts its shared memory after many open/close cycles.
